        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Pencarian User </h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                  <li class="breadcrumb-item active" aria-current="page"> Pencarian Siswa</li>
                </ol>
              </nav>
            </div>
            <div class="row">
                  ...
                  <div class="card-body">
                    <form method="post">
                      <div class="form-group">
                        ...
                        <br><br>
                        <input id="searchdata" type="text" name="searchdata" required="true" class="form-control" placeholder="Cari Menggunakan UserID">
                      </div>
                    ...
                    <div class="d-sm-flex align-items-center mb-4">
                      ...
                      ?>
                        <h4 align="center">Hasil Pencarian Dengan UserID "<?php echo $sdata; ?>"</h4>
                    </div>
                              ...
                              <tr>
                                ...
                                <td>
                                  <div><a href="edit-student-detail.php?editid=<?php echo htmlentities($row->sid); ?>"><i class="icon-eye"></i></a>
                                    || <a href="manage-students.php?delid=<?php echo ($row->sid); ?>" onclick="return confirm('Apakah Kamu Yakin Ingin Menghapus ?');"> <i class="icon-trash"></i></a></div>
                                </td>
                              </tr><?php
                                    $cnt = $cnt + 1;
                                  }
