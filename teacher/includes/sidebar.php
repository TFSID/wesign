    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="auth">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link" href="add-notice.php"> Tambah Task </a></li>
          <li class="nav-item"> <a class="nav-link" href="manage-notice.php"> Kelola Task </a></li>
        </ul>
      </div>
    </li>
    <li class="nav-item">
      ...
      <div class="collapse" id="ui-basic1">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link" href="manage-students.php">Designer List</a></li>
        </ul>
      </div>
    </li>
    <li class="nav-item">
