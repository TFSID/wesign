                    ...
                    <div class="row report-inner-cards-wrapper">
                      <div class=" col-md -6 col-xl report-inner-card">
                        <div class="inner-card-text">
                          ...
                          ?>
                          <span class="report-title">Feedback Report</span>
                          <h4><?php echo htmlentities($totclass); ?></h4>
                          <a href="manage-class.php"><span class="report-count"> Lihat Detail</span></a>
                        </div>
                      ...
                      <div class="col-md-6 col-xl report-inner-card">
                        <div class="inner-card-text">
                          ...
                          ?>
                          <span class="report-title">Jumlah Karyawan</span>
                          <h4><?php echo htmlentities($totstu); ?></h4>
                          <a href="manage-students.php"><span class="report-count"> Lihat Detail</span></a>
                        </div>
                      ...
                      <div class="col-md-6 col-xl report-inner-card">
                        <div class="inner-card-text">
                          ...
                          ?>
                          <span class="report-title">Task List</span>
                          <h4><?php echo htmlentities($totnotice); ?></h4>
                          <a href="manage-notice.php"><span class="report-count"> Lihat Detail</span></a>
                        </div>
                      ...
                      <div class="col-md-6 col-xl report-inner-card">
                        <div class="inner-card-text">
                          ...
                          ?>
                          <span class="report-title">Update Report</span>
                          <h4><?php echo htmlentities($totpublicnotice); ?></h4>
                          <a href="manage-public-notice.php"><span class="report-count"> Lihat Detail</span></a>
                        </div>
