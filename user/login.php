          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left p-5">
              <div class="brand-logo">
                <h4 style="text-align: center;">COMMUNITY APPLICATION</h4>
              </div>
              <h4>Hello! Selamat Datang </h4>
              <h6 class="font-weight-light">Login Sebagai Desainer.</h6>
              <form class="pt-3" id="login" method="post" name="login">
                <div class="form-group">
                  <input type="text" class="form-control form-control-lg" placeholder="Masukkan Username" required="true" name="stuid" value="<?php if (isset($_COOKIE["user_login"])) {
                ...
                <div class="mb-2">
                  <a href="../loginchoose.php" class="btn btn-block btn-facebook auth-form-btn">
                    <i class="icon-social-home mr-2"></i>Pilih Divisi</a>
                </div>
                <div class="mb-2">
